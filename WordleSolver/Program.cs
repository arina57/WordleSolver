...
wordAnalyzer.AddGuess("arose", new List<Result> { Result.Yellow, Result.Grey, Result.Grey, Result.Grey, Result.Grey });
Console.WriteLine(wordAnalyzer.SuggestGuess());
wordAnalyzer.AddGuess("inula", new List<Result> { Result.Grey, Result.Grey, Result.Green, Result.Green, Result.Yellow });
Console.WriteLine(wordAnalyzer.SuggestGuess());
